...
The first step that we took was to remove significant outliers from our dataset that would negatively affect the model. For example, a house was present with 33 bedrooms and 1.75 bathrooms that was well below the average house price in the dataset. After this initial trim, the distributions of features were observed using the following histogram figure.

<img src="images/initial_histograms.png" width="750">
