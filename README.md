...
We found the `sqft_living` column to be especially useful because of the high correlation value that we found it had with our target variable `price`. We can also see here that the two columns `price` and `sqft_living` both have skewed distributions of data. So we will have to scale and transform our data to get a more normal distribution as well as get an understanding of their relation in a more uniform relative context.

<img src="images/sqft_living_regplot.png" width="750">

Looking at this relationship through a bar graph provides a picture that is easier on the eye. The visual below shows us very clearly how higher living square footage may have an influence on the price of the property itself.

<img src="images/pro2viz.png" width="750">
